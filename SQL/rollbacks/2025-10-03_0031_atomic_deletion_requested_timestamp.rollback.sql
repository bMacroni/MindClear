-- Rollback: Atomic deletion_requested_at timestamp
-- Date: 2025-10-03
-- Description: Reverts to previous version where deletion_requested_at was set
--              outside the transaction (restores migration 0030 function)
...
DO $$
BEGIN
  RAISE NOTICE '✓ Rollback 2025-10-03_0031 completed successfully';
  RAISE NOTICE '  - Reverted to migration 0030 function signature';
  RAISE NOTICE '  - deletion_requested_at must be set outside transaction again';
END $$;
